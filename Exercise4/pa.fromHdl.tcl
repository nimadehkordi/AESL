...
create_project -name Exercise4 -dir "C:/Projects/Exercise4/planAhead_run_1" -part xc6slx45fgg676-3
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "blinkingLed.ucf" [current_fileset -constrset]
set hdlfile [add_files [list {blinkingLed.vhd}]]
set_property file_type VHDL $hdlfile
set_property library work $hdlfile
set_property top blinkingLed $srcset
